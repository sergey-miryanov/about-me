...
## Разбор внутреннего устройства сборщика мусора CPython 3.14+
...
2. [Что не так с cProfile в Python / Хабр](https://habr.com/ru/articles/871318/)
3. [Как реализовать быструю реентерабельную блокировку на Python и почему она работает / Хабр](https://habr.com/ru/articles/855728/)

## Прочее
1. [Qt-шные прокси-модели и их друзья / Хабр](https://habr.com/ru/articles/851850/)
